...
\item 
int \mbox{\hyperlink{group__manager_8c_a26f90779d7b5d23ba3ff7ff7e27b5a6e}{copy\+\_\+group\+\_\+t\+\_\+to\+\_\+user}} (\+\_\+\+\_\+user \mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$user\+\_\+group, \mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$kern\+\_\+group)
\begin{DoxyCompactList}\small\item\em Copy a \textquotesingle{}\mbox{\hyperlink{structgroup__t}{group\+\_\+t}}\textquotesingle{} structure to user space. \end{DoxyCompactList}\item 
...
bool \mbox{\hyperlink{group__manager_8c_a23d542ee909293c2d1157e307b26a923}{is\+Owner}} (\mbox{\hyperlink{structgroup__data}{group\+\_\+data}} $\ast$grp\+\_\+data)
\begin{DoxyCompactList}\small\item\em Test if the current process is the owner of a group. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{group__manager_8c_a780fe5d837bfeaed74b75aa962a51796}{change\+Owner}} (\mbox{\hyperlink{structgroup__data}{group\+\_\+data}} $\ast$grp\+\_\+data, uid\+\_\+t new\+\_\+owner)
\begin{DoxyCompactList}\small\item\em Change the current owner of a group. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{group__manager_8c_a734209fad91aa5312f1070d9eaf32df0}{set\+Strict\+Mode}} (\mbox{\hyperlink{structgroup__data}{group\+\_\+data}} $\ast$grp\+\_\+data, const bool enabled)
\begin{DoxyCompactList}\small\item\em Change group\textquotesingle{}s \textquotesingle{}strict\textquotesingle{} security flag. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Handler of group\textquotesingle{}s ioctls requests. \end{DoxyCompactList}\item 
\+\_\+\+\_\+must\+\_\+check int \mbox{\hyperlink{group__manager_8c_a8cdd4e522e45cb3aacc2c01ef8aa2c5f}{copy\+\_\+group\+\_\+t\+\_\+from\+\_\+user}} (\+\_\+\+\_\+user \mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$user\+\_\+group, \mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$kern\+\_\+group)
...
nothing 
\end{DoxyReturn}
\mbox{\Hypertarget{group__manager_8c_a780fe5d837bfeaed74b75aa962a51796}\label{group__manager_8c_a780fe5d837bfeaed74b75aa962a51796}} 
\index{group\_manager.c@{group\_manager.c}!changeOwner@{changeOwner}}
\index{changeOwner@{changeOwner}!group\_manager.c@{group\_manager.c}}
\doxysubsubsection{\texorpdfstring{changeOwner()}{changeOwner()}}
{\footnotesize\ttfamily int change\+Owner (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structgroup__data}{group\+\_\+data}} $\ast$}]{grp\+\_\+data,  }\item[{uid\+\_\+t}]{new\+\_\+owner }\end{DoxyParamCaption})}



Change the current owner of a group. 

\begin{DoxyNote}{Note}
If strict mode is enabled, only the owner of a group can call this function.
\end{DoxyNote}

\begin{DoxyRetVals}{Return values}
{\em 0} & on success \\
\hline
{\em -\/1} & if the current process is not authorized \\
\hline
\end{DoxyRetVals}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__manager_8c_a8cdd4e522e45cb3aacc2c01ef8aa2c5f}\label{group__manager_8c_a8cdd4e522e45cb3aacc2c01ef8aa2c5f}} 
\index{group\_manager.c@{group\_manager.c}!copy\_group\_t\_from\_user@{copy\_group\_t\_from\_user}}
\index{copy\_group\_t\_from\_user@{copy\_group\_t\_from\_user}!group\_manager.c@{group\_manager.c}}
\doxysubsubsection{\texorpdfstring{copy\_group\_t\_from\_user()}{copy\_group\_t\_from\_user()}}
{\footnotesize\ttfamily \+\_\+\+\_\+must\+\_\+check int copy\+\_\+group\+\_\+t\+\_\+from\+\_\+user (\begin{DoxyParamCaption}\item[{\+\_\+\+\_\+user \mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$}]{user\+\_\+group,  }\item[{\mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$}]{kern\+\_\+group }\end{DoxyParamCaption})}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__manager_8c_a26f90779d7b5d23ba3ff7ff7e27b5a6e}\label{group__manager_8c_a26f90779d7b5d23ba3ff7ff7e27b5a6e}} 
\index{group\_manager.c@{group\_manager.c}!copy\_group\_t\_to\_user@{copy\_group\_t\_to\_user}}
\index{copy\_group\_t\_to\_user@{copy\_group\_t\_to\_user}!group\_manager.c@{group\_manager.c}}
\doxysubsubsection{\texorpdfstring{copy\_group\_t\_to\_user()}{copy\_group\_t\_to\_user()}}
{\footnotesize\ttfamily \+\_\+\+\_\+must\+\_\+check int copy\+\_\+group\+\_\+t\+\_\+to\+\_\+user (\begin{DoxyParamCaption}\item[{\+\_\+\+\_\+user \mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$}]{user\+\_\+group,  }\item[{\mbox{\hyperlink{structgroup__t}{group\+\_\+t}} $\ast$}]{kern\+\_\+group }\end{DoxyParamCaption})}



Copy a \textquotesingle{}\mbox{\hyperlink{structgroup__t}{group\+\_\+t}}\textquotesingle{} structure to user space. 
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__manager_8c_a23d542ee909293c2d1157e307b26a923}\label{group__manager_8c_a23d542ee909293c2d1157e307b26a923}} 
\index{group\_manager.c@{group\_manager.c}!isOwner@{isOwner}}
\index{isOwner@{isOwner}!group\_manager.c@{group\_manager.c}}
\doxysubsubsection{\texorpdfstring{isOwner()}{isOwner()}}
{\footnotesize\ttfamily bool is\+Owner (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structgroup__data}{group\+\_\+data}} $\ast$}]{grp\+\_\+data }\end{DoxyParamCaption})}



Test if the current process is the owner of a group. 


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em grp\+\_\+data} & A group main structure\\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
\begin{DoxyRetVals}{Return values}
{\em true} & if the current process is the owner \\
\hline
{\em false} & if the current process is not the owner \\
\hline
\end{DoxyRetVals}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__manager_8c_a734209fad91aa5312f1070d9eaf32df0}\label{group__manager_8c_a734209fad91aa5312f1070d9eaf32df0}} 
\index{group\_manager.c@{group\_manager.c}!setStrictMode@{setStrictMode}}
\index{setStrictMode@{setStrictMode}!group\_manager.c@{group\_manager.c}}
\doxysubsubsection{\texorpdfstring{setStrictMode()}{setStrictMode()}}
{\footnotesize\ttfamily int set\+Strict\+Mode (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structgroup__data}{group\+\_\+data}} $\ast$}]{grp\+\_\+data,  }\item[{const bool}]{enabled }\end{DoxyParamCaption})}



Change group\textquotesingle{}s \textquotesingle{}strict\textquotesingle{} security flag. 


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em grp\+\_\+data} & A group structure where the flag should be set \\
\hline
\mbox{\texttt{ in}}  & {\em enabled} & True if the flag must be enabled, false otherwise\\
\hline
\end{DoxyParams}
...
{\em 0} & On success \\
\hline
{\em -\/1} & If the current process is unauthorized \\
\hline
\end{DoxyRetVals}
