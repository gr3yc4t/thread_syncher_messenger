...
First of all, an application has to initialize a thread\+\_\+synch\+\_\+t structure via \mbox{\hyperlink{thread__synch_8h_a0b9a508c4355883d84619d4472c4e0a3}{init\+Thread\+Syncher()}} in order to interact with the module’s functionalities. At some point the user-\/level app would interact with a module’s group by obtaining a thread\+\_\+group\+\_\+t structure, and this can be done in three ways\+:
\begin{DoxyItemize}
...
Each one of these functions return a pointer to an initialized \mbox{\hyperlink{structT__THREAD__GROUP}{thread\+\_\+group\+\_\+t}} structure (or N\+U\+LL in case of error) and, with the exception of the last one, they need athread\+\_\+synch\+\_\+t structure as parameter. To correctly use the module subsystems, applications have to open groups to become active members of them via the function \mbox{\hyperlink{thread__synch_8h_a6f4b8c5c4cd71b55b693b19477192042}{open\+Group()}}. In case the library\textquotesingle{}s functions are called with a closed \mbox{\hyperlink{structT__THREAD__GROUP}{thread\+\_\+group\+\_\+t}} structure as a parameter they will return -\/1.\hypertarget{user_lib_msg_subsystem_user}{}\doxysection{Message Subsystem}\label{user_lib_msg_subsystem_user}
